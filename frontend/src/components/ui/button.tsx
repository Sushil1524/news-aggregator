  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-base focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        filled: "bg-primary text-primary-foreground shadow-elevation-1 hover:shadow-elevation-2 hover:bg-primary/90",
        secondary: "bg-secondary text-secondary-foreground shadow-elevation-1 hover:shadow-elevation-2 hover:bg-secondary/90",
        tertiary: "bg-tertiary text-tertiary-foreground shadow-elevation-1 hover:shadow-elevation-2 hover:bg-tertiary/90",
        outlined: "border-2 border-primary bg-transparent text-primary hover:bg-primary/10",
        text: "text-primary hover:bg-primary/10",
        destructive: "bg-destructive text-destructive-foreground shadow-elevation-1 hover:shadow-elevation-2 hover:bg-destructive/90",
